...
# ----------------------------
StatusNotExec = 'Kördes inte'
StatusProhibited = 'Förbjudet'
StatusNotCompleted = 'Slutfördes inte'
StatusOK = 'OK'
StatusWarning = 'Varning'
StatusFailed = 'Misslyckades'
StatusDanger = 'Fara'
StatusNote = 'Obs'
StatusDownload = 'Nedladdning %s'
StatusUpload = 'Uppladdning %s'
StatusUpDown = 'Uppladdning %s, Nedladdning %s'
StatusV6Problem = 'Accessproblem med IPv6'
StatusV6None = 'Ingen IPv6 support'

# Various in-server strings
# ----------------------------------------------------------------------

NetalyzrProblem = '''<p>
Det verkar var allvarliga problem med att köra Netalyzr denna gången,
eftersom det antingen var omöjligt att slå upp namnet på vår server i DNS,
och/eller ansluta till den. Beroende på detta är resultatet mycket osäkert.
</p>
<p>
Vårt första förslag är att avsluta webbläsaren helt och försöka igen. Om det
misslyckas, <a href="mailto:netalyzr-help@icsi.berkeley.edu">skicka ett mail till oss</a>
så kommer vi försöka diagnosticera och felsöka problemet. Tack på förhand.
</p>'''

NetalyzrOverload = 'Beroende på stor användning just nu kan denna test ej genomföras. '
DNSWildcardLink = "data för s.k. wildcard DNS"
TimeNextDay = 'nästa dag'
Referrer = 'Hänvisning'
NoResults = 'Inga resultat hittade. '
MinorAberrations = 'Mindre avvikelser'
MajorAbnormalities = 'Större avvikelser'
InternalError = 'Internt fel på servern när testrapport skall skapas'
SummaryNoteworthy = 'Sammanfattning av anmärkningsvärda händelser'
NoServerTranscript = 'Tyvärr ingen logg från serversidan. '
NoClientTranscript = 'Tyvärr ingen logg från klientsidan. '

# Generic test outcomes
# -----------------------

TestNotExecuted = \
"Testet kördes inte. Funktionalitet eller accessrättigheter var ej tillräckliga."

TestFailedToComplete = \
"Testet misslyckades helt med att utföras."

TestProhibited = \
"""Appleten fick inte utföra testerna fullständigt. Vi föreslår
du startar om testet och tillåter applet att utföra sina handlingar
om du blir tillfrågad. Notera dock att vissa systeminställningar
alltid kan blockera denna test. Se vår <a href="/faq.html#permissions"
target="_blank">FAQ</a> för mer hjälp."""

TestError = \
"Ett ospecificerat fel inträffade under körningen."

TestErrorUnknownHost = \
"Ett eller flera datornamn som behövs för testen kunde inte slås upp."

TestErrorIO = \
"Ett I/O fel inträffade under testen. Felkod är %i."

TestFailed = "Misslyckades"

# Are there things of significant note

NoProblems = \
"""Vi kunde inte se några allvarliga problem med din nätanslutning"""

Problems = \
"""Vi upptäckte följande problem, som är värda att notera: """

NoWarnings = \
"""Vi kunde inte upptäcka några mindre problem"""

Warnings = \
"""Vi upptäckte följande mindre till medelsvåra problem: """


# Test category names
# -------------------
CatAddress = 'Adressrelaterade tester'
CatReachability = 'Nåbarhetstester'
CatAccessLink = 'Accesslänkens karaktäristik'
CatHTTP = 'Tester av HTTP'
CatDNS = 'Tester av DNS'
CatIPv6 = 'Tester av IPv6'
CatFuture = 'Utökning av Internet'
CatHost = 'Kontroll av dator'
CatFeedback = 'Återkoppling'

# Test names
# ----------

CheckLocalAddr = 'Detektion av adressöversättning (NAT)'
CheckLocalInterface = 'Lokala nätverksinterface'
CheckURL = 'Adressbaserad detektion av HTTP proxy'
CheckLowHTTP = 'Headerbaserad detektion av HTTP proxy'
CheckMalformedHTTP = 'Detektion av HTTP proxy genom felaktiga anrop'
CheckHTTPCache = 'Kontroll av HTTP cache'
CheckRestrictedDNS = 'Lookup av speciella domännamn i DNS'
CheckBandwidth = 'Kontroll av bandbredd'
CheckBuffer = 'Kontroll av buffertstorlek'
CheckDNSResolver = 'Kontroll av DNS resolver'
CheckLatency = 'Mätning av nätverksfördröjningar'
CheckTCPSetupLatency = 'Tid det tar att etablera en TCP-förbindelse'
CheckBackgroundHealth = 'Mätning av nätfunktionalitet i bakgrunden'
CheckUnrestrictedDNS = 'Uppslagning av slumpvisa domännamn i DNS'
CheckDirectedEDNS = 'Direkt support av EDNS'
CheckDirectDNS = 'Direkt support av DNS'
CheckPathMTU = 'Path MTU'
CheckPathMTUV6 = 'IPv6 Path MTU'
CheckTraceroute = 'Traceroute'
CheckTracerouteV6 = 'IPv6 Traceroute'
CheckJS = 'JavaScript-baserade tester'
CheckDNSGlue = 'Policy för DNS glue'
CheckDNSLookups = 'Uppslagning av populära domännamn i DNS'
CheckUDPConnectivity = 'Access med UDP'
CheckTCPConnectivity = 'Access med TCP'
CheckFiletypeFiltering = 'Filtypsbaserad filtering'
CheckDNSResolverAddress = 'Adress till DNS resolver'
CheckDNSRand = 'Slumpvis val av port av DNS resolver'
CheckDNSProxy = 'DNS extern proxy'
CheckClockAccuracy = 'Noggrannhet för systemklocka'
CheckUploadedData = 'Uppladdd information'
CheckBrowser = 'Webbläsarinställningar'
CheckDNSWildcarding = 'Resultat från s.k. DNS wildcard'
CheckDNSHostInfo = 'DNS-baserad datorinformation'
CheckIPv6DNS = 'Support för IPv6 i DNS'
CheckIPv6Connectivity = 'Access med IPv6'
CheckIPv6TCPConnectivity = 'Access med TCP över IPv6'
CheckIPv6Javascript = 'IPv6 och din webbläsare'

CheckFutureHost = 'Framtidssäker dator'
CheckFutureNat = 'Framtidssäker adressöversättning (NAT)'
CheckFutureNetwork = 'Framtidssäkert Nätverk'
...
LocalAddressRoutable = 'routbar'
LocalAddressUnroutable = 'icke routbar'

LocalAddressSummaryNoNat = '''Ingen NAT upptäcktes'''
LocalAddressSummaryNat = '''NAT upptäcktes'''
LocalAddressSummaryNatUnknown = '''Okänd status för NAT'''

LocalAddressContentFailure = '''<P>En av anslutningarna till vår server
fick inte den information som förväntades.</P>'''

LocalAddressNoNat = '''<P>Din globala IP-adress är %s och matchar den lokala. 
Du är ej bakom en adressöversättning (NAT).</P>'''

LocalAddressUnknown = '''<p>Din globala IP-adress är %s. Din lokala IP-adress
gick ej att ta reda på, så vi kan ej säga om du är bakom en adressöversättning (NAT)
eller inte.</p>'''

LocalAddressNatUnknown = '''<p>Din globala IP-adress är %s. Din lokala IP-adress
gick ej att ta reda på, så vi kan ej säga om du är bakom en adressöversättning (NAT)
eller inte.</p>'''

LocalAddressNat = '''<P>Din globala IP-adress är %(global)s medan din lokala är %(local)s.
Du är bakom en adressöversättning (NAT). Din lokala adress är i adressutrymmet %(routable)s.</P>'''

LocalAddressNatNoRoute = '''<P>Din globala IP-adress är %(global)s medan din lokala
är %(local)s. Du är bakom en adressöversättning (NAT).</P>'''

LocalAddressMultiple = '''<P>Multipla kommandon kom från
%d olika klientadresser.</P>'''

LocalAddressNatSequential = '<P>Din adressöversättning (NAT) väljer portnummer för TCP linjärt.  '
LocalAddressSequential = '<P>Din dator väljer portnummer för TCP linjärt.  '

LocalAddressNatRandom = '<P>Din adressöversättning (NAT) väljer portnummer för TCP slumpmässigt.  '
LocalAddressRandom = '<P>Din dator väljer portnummer för TCP slumpmässigt.  '


LocalAddressGraph = '''Följande graf visar anslutningsförsök på X-axeln
och deras respektive portnummer som valts av din dator på Y-axeln.</P>'''

NatRenumbered = '<P>Adressöversättaren (NAT) eller något annat numrerar om portnummer för TCP. '
Renumbered = '<P>Någonting i nätet numrerar om portnummer för TCP. '
NoRenumbered = '<P>Ingenting förändrar portnummer för TCP i nätverket.</P>'
